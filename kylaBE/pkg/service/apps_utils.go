...
func PbAppToApp(pbApp *pb.App, scope *OpScope) *App {
...
func AppToPbApp(app *App, scope *OpScope) *pb.App {
	return &pb.App{
		Id:                   app.ID.String(),
		Token:                app.Token,
		Name:                 app.Name,
...
func PbAppsToApps(pbApps []*pb.App, scope *OpScope) []*App {
	apps := make([]*App, 0)
...
func AppsToPbApps(apps []*App, scope *OpScope) []*pb.App {
