...
const (
	EventService_CreateEvent_FullMethodName = "/da.proto.EventService/CreateEvent"
	EventService_ReadEvent_FullMethodName   = "/da.proto.EventService/ReadEvent"
	EventService_UpdateEvent_FullMethodName = "/da.proto.EventService/UpdateEvent"
	EventService_ReadEvents_FullMethodName  = "/da.proto.EventService/ReadEvents"
	EventService_DeleteEvent_FullMethodName = "/da.proto.EventService/DeleteEvent"
)
...
func (c *eventServiceClient) ReadEvents(ctx context.Context, in *ReadEventsRequest, opts ...grpc.CallOption) (*ReadEventsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ReadEventsResponse)
	err := c.cc.Invoke(ctx, EventService_ReadEvents_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedEventServiceServer) ReadEvents(context.Context, *ReadEventsRequest) (*ReadEventsResponse, error) {
...
func _EventService_ReadEvents_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EventService_ReadEvents_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EventServiceServer).ReadEvents(ctx, req.(*ReadEventsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var EventService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "da.proto.EventService",
