...
const (
	TagService_CreateTag_FullMethodName = "/da.proto.TagService/CreateTag"
	TagService_ReadTag_FullMethodName   = "/da.proto.TagService/ReadTag"
	TagService_ReadTags_FullMethodName  = "/da.proto.TagService/ReadTags"
	TagService_UpdateTag_FullMethodName = "/da.proto.TagService/UpdateTag"
	TagService_DeleteTag_FullMethodName = "/da.proto.TagService/DeleteTag"
)
...
func (c *tagServiceClient) ReadTag(ctx context.Context, in *ReadTagRequest, opts ...grpc.CallOption) (*ReadTagResponse, error) {
	...
	err := c.cc.Invoke(ctx, TagService_ReadTag_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tagServiceClient) ReadTags(ctx context.Context, in *ReadTagsRequest, opts ...grpc.CallOption) (*ReadTagsResponse, error) {
	...
	err := c.cc.Invoke(ctx, TagService_ReadTags_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTagServiceServer) ReadTags(context.Context, *ReadTagsRequest) (*ReadTagsResponse, error) {
...
func _TagService_ReadTag_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TagService_ReadTag_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TagService_ReadTags_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TagService_ReadTags_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var TagService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "da.proto.TagService",
