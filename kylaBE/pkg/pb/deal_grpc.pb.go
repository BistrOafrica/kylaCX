...
const (
	DealService_CreateDeal_FullMethodName = "/da.proto.DealService/CreateDeal"
	DealService_ReadDeal_FullMethodName   = "/da.proto.DealService/ReadDeal"
	DealService_ReadDeals_FullMethodName  = "/da.proto.DealService/ReadDeals"
	DealService_UpdateDeal_FullMethodName = "/da.proto.DealService/UpdateDeal"
	DealService_DeleteDeal_FullMethodName = "/da.proto.DealService/DeleteDeal"
)
...
type DealServiceClient interface {
	...
	ReadDeals(ctx context.Context, in *ReadDealsRequest, opts ...grpc.CallOption) (*ReadDealsResponse, error)
...
func (c *dealServiceClient) ReadDeals(ctx context.Context, in *ReadDealsRequest, opts ...grpc.CallOption) (*ReadDealsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ReadDealsResponse)
	err := c.cc.Invoke(ctx, DealService_ReadDeals_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dealServiceClient) UpdateDeal(ctx context.Context, in *UpdateDealRequest, opts ...grpc.CallOption) (*UpdateDealResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *dealServiceClient) DeleteDeal(ctx context.Context, in *DeleteDealRequest, opts ...grpc.CallOption) (*DeleteDealResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DeleteDealResponse)
	err := c.cc.Invoke(ctx, DealService_DeleteDeal_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DealServiceServer interface {
	...
	ReadDeals(context.Context, *ReadDealsRequest) (*ReadDealsResponse, error)
...
func (UnimplementedDealServiceServer) ReadDeals(context.Context, *ReadDealsRequest) (*ReadDealsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ReadDeals not implemented")
}
func (UnimplementedDealServiceServer) UpdateDeal(context.Context, *UpdateDealRequest) (*UpdateDealResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateDeal not implemented")
}
func (UnimplementedDealServiceServer) DeleteDeal(context.Context, *DeleteDealRequest) (*DeleteDealResponse, error) {
...
func _DealService_ReadDeals_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReadDealsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DealServiceServer).ReadDeals(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DealService_ReadDeals_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DealServiceServer).ReadDeals(ctx, req.(*ReadDealsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _DealService_DeleteDeal_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteDealRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DealServiceServer).DeleteDeal(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DealService_DeleteDeal_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DealServiceServer).DeleteDeal(ctx, req.(*DeleteDealRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DealService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "da.proto.DealService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ReadDeals",
			Handler:    _DealService_ReadDeals_Handler,
		},
		{
		...
		},
		{
			...
			Handler:    _DealService_DeleteDeal_Handler,
		},
	},
