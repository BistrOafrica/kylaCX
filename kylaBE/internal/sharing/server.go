...
// AuthGateway defines the auth methods the SharingServer needs from AuthStore.
type AuthGateway interface {
	GetUserRequestMetadata(ctx context.Context, dataChan chan *authctx.RequestMetadata, err chan error)
}
...
func NewSharingServer(sharingStore *SharingStore, authStore AuthGateway) *SharingServer {
